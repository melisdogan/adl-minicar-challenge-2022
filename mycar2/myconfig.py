...
MM1_MAX_FORWARD = 1636 #1650  # 1620 Middle Value, Max is 2000
...
STEERING_RIGHT_PWM=109
STEERING_LEFT_PWM=100

#THROTTLE
THROTTLE_CHANNEL = 0            #channel on the 9685 pwm board 0-15
THROTTLE_FORWARD_PWM = 215 #430      #pwm value for max forward throttle
THROTTLE_STOPPED_PWM = 370      #pwm value for no movement
THROTTLE_REVERSE_PWM = 320      #pwm value for max reverse throttle
AI_THROTTLE_MULT = 0.9 #AI throttle speed multiplier 
